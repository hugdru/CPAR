...
public class Matrix {
	...
	public static Matrix MultiplicationNaiveSequential(Matrix matrix_a, Matrix matrix_b) throws Exception {
		...
		/*
		 * int mat_a_rows = matrix_a.getRowsLength(); int mat_a_col = matrix_a.getColumnsLength(); double[] mat_a_val = matrix_a.getValues();
		 * 
		 * int mat_b_col = matrix_b.getColumnsLength(); double[] mat_b_val = matrix_b.getValues();
		 * 
		 * Matrix matrix_result = new Matrix(mat_a_rows, mat_b_col); int mat_res_col = matrix_result.getColumnsLength(); double[] mat_res_val = matrix_result.getValues();
		 */
